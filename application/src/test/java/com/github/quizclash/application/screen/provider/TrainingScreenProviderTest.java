...
class TrainingScreenProviderTest {
  ...
  void setUp() throws InvalidQuestionFormatException {
    ...
    trainingScreenProvider = new TrainingScreenProvider(repository, screenFactory);
  }

  @Test
  void getNextScreenProviderType() {
    assertEquals(ScreenProviderType.MENU, trainingScreenProvider.getNextScreenProviderType());
  }
}